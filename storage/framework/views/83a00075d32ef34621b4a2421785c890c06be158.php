    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800">Host Profile</h1>
        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <form enctype="multipart/form-data" action="/host/HostProfile" method="POST">
                    <?php echo e(csrf_field()); ?>

                    <label for="file">
                    <i class="fa fa-camera"></i>
                    <input type="file" id="file" style="display: none" name="avatar" multiple="" data-original-title="upload photos">
                    </label>
                    <label for="uploadfile">
                    <i class="fa fa-upload"></i>
                    <input type="submit" name="upload" id="uploadfile" style="display: none; margin-right: 25px;">
                    </label>
                    </form>
                  </div>
                  <div class="col-md-8">
...
<?php echo $__env->make('layouts\HostLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lmao3d\resources\views/host/hostProfile.blade.php ENDPATH**/ ?>