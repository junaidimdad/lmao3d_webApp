        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="user">
               <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="text-center">
                    ...
                    <a class="small" href="<?php echo e(route('admin.password.request')); ?>">Forgot Password?</a>
                    <?php endif; ?>
              </div>
              <div class="text-center">
...
</html><?php /**PATH C:\xampp\htdocs\lmao3d\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>