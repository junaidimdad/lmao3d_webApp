    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <a href="<?php echo e(route('host.File.index')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-eye fa-sm text-white-50"></i> View Files</a>
        </div>
        <!-- File Uploading Form Area-->
        <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">View PDF Files</h6>
        </div>
        <div class="card-body" style="height:85vh;">
        <?php if(Auth::user()->id == $file->user_id): ?>
        <iframe src="<?php echo e(url('storage/'.$file->file)); ?>" style="width:100%; height:80vh;"></iframe>
        <?php endif; ?>
        </div>
        </div>
...
<?php echo $__env->make('layouts\HostLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lmao3d\resources\views/host/uploadFiles/show.blade.php ENDPATH**/ ?>