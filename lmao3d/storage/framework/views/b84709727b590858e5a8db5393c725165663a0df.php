      ...
      <div class="row">
          ...
          <nav class="navbar navbar-default">
              ...
              <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                  <a class="page-scroll" href="<?php echo e(route('clientadminsuggestion.create')); ?>">Contact</a>
                  </li>
              </ul>
              </div>
              <!-- navbar-collapse -->
  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="<?php echo e(URL::asset('Content/img/slider/slider1.jpg')); ?>" alt="" title="#slider-direction-1" />
        <img src="<?php echo e(URL::asset('Content/img/slider/slider2.jpg')); ?>" alt="" title="#slider-direction-2" />
        <img src="<?php echo e(URL::asset('Content/img/slider/slider3.jpg')); ?>" alt="" title="#slider-direction-3" />
      </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="<?php echo e(route('login')); ?>">Join as Host</a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#"><img src="<?php echo e(URL::asset('Content/img/about/1.jpg')); ?>" alt=""></a>
            </div>
          </div>
        </div>
        <!-- single-well end-->
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#"><img src="<?php echo e(URL::asset('Content/img/team/1.jpg')); ?>" alt=""></a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#"><img src="<?php echo e(URL::asset('Content/img/team/2.jpg')); ?>" alt=""></a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
                      <a href="#"><i class="fa fa-facebook"></i></a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#"><img src="<?php echo e(URL::asset('Content/img/team/4.jpg')); ?>" alt=""></a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
                      <a href="#"><i class="fa fa-facebook"></i></a>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      <div class="work-left-text">
        <a href="#"><img src="<?php echo e(URL::asset('Content/img/about/2.jpg')); ?>" alt=""></a>
      </div>
              ...
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo e(URL::asset('Content/img/portfolio/1.jpg')); ?>">
                      <h4>Business city</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo e(('Content/img/portfolio/2.jpg')); ?>">
                      <h4>Blue Sea</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?php echo e(URL::asset('Content/img/portfolio/3.jpg')); ?>">
...
<?php echo $__env->make('layouts\LandingLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lmao3d\resources\views/welcome.blade.php ENDPATH**/ ?>